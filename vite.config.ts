...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'מדריך יפן',
        short_name: 'מדריך יפן',
        description: 'מדריך טיול ליפן - אוסקה, קיוטו, פוג\'י, האקונה וטוקיו - עובד גם בלי אינטרנט',
        lang: 'he',
        dir: 'rtl',
        start_url: '/japan-trip-guide/',
        scope: '/japan-trip-guide/',
        display: 'standalone',
      ...
      workbox: {
        ...
        navigateFallback: '/japan-trip-guide/index.html',
      },
    }),
  ],
})
