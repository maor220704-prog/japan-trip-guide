 ...
 * that make the bottom bar redundant there. Checking the route here -
 * instead of not mounting NavBar in App.tsx - keeps it always mounted, so
 * it still survives page crashes.
 */
        ...
        >
          {({ isActive }) => (
            <>
              ...
              <span className="text-xs font-medium">מסלול</span>
            </>
          )}
        </NavLink>
        <NavLink
