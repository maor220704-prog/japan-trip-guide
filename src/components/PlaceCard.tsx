 ...
 * never from coordinates (coordinates are never invented, so the nav button
 * is always built from text instead).
 */
...
export default function PlaceCard({ place, showCategory }: PlaceCardProps) {
  ...
  return (
    <li className="rounded-xl bg-surface p-4 shadow-[0_8px_20px_-4px_rgba(115,121,113,0.12)]">
      ...
      {/* The Latin name is what you type into a map or show to a local when
          the navigation button cannot open. */}
