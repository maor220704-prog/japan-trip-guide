...
export const fuji: CityContent = {
  ...
  places: [
    ...
    },
    {
      ...
      description:
        "שמונה בריכות מים צלולים בין אגמי קוואגוצ'יקו ויאמאנאקה, המוזנות במי שלג נמסים מהר פוג'י שסוננו עשרות שנים דרך שכבות לבה. הכפר הקטן סביבן, עם בתי קש מסורתיים, הוא חלק ממורשת העולם של אונסק"ו הקשורה להר פוג'י.",
